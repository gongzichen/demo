    ...
    window.Brid = Class.extend({
        ...
        render:function(){
            if(this.die){
                ...
                //绘制洒热血
                game.ctx.drawImage(game.sallImageObj['blood'],sWidth * col , sHeight * row ,sWidth , sHeight , this.x -100,this.y,sWidth,sHeight );
                //绘制游戏结束
                game.ctx.drawImage(game.sallImageObj['gameover'], (game.canvas.width - 626) * 0.5,
        ...
        update:function(){
            ...
            if(this.birdState ==  0 ) {
                ...
                this.dy = 0.5 * 0.001 * 9.8 * Math.pow(game.frameUtil.currentFrame - this.dropFrame, 2);
                this.rotateAngle +=1;
